...
namespace ScribbleHunter
{
    class MainMenuManager
    {
        ...
        private const string UpgradeGameAction = "UpgradeGames";
        ...
        public void SetupInputs()
        {
            ...
            gameInput.AddTouchGestureInput(UpgradeGameAction,
                                           GestureType.Tap,
                                           upgradeGameDestination);
        }
        ...
        private void handleTouchInputs()
        {
            ...
            // Upgrade game
            else if (gameInput.IsPressed(UpgradeGameAction))
            {
