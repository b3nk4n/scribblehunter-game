...
namespace ScribbleHunter.Inputs
{
    class Input
    {
        ...
        public Input()
        {
            ...
            {
                accelerometerSensor = Accelerometer.GetDefault();
                if (accelerometerSensor != null)
                {
        ...
        void accelerometerSensor_ReadingChanged(Accelerometer sender, AccelerometerReadingChangedEventArgs e)
        {
            currentAccelerometerReading.X = (float)e.Reading.AccelerationX;
            currentAccelerometerReading.Y = (float)e.Reading.AccelerationY;
            currentAccelerometerReading.Z = (float)e.Reading.AccelerationZ;
        }
