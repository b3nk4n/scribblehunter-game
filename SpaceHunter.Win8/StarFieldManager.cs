...
namespace ScribbleHunter
{
    class StarFieldManager
    {
        ...
        private Color[] colors = { Color.Gray * 0.66f,
                                   Color.Wheat * 0.75f,
                                   Color.LightGray * 0.75f,
                                   Color.SlateGray * 0.66f};
        ...
        {
            this.currentIndexX = Int32.Parse(data.Dequeue());
            this.currentIndexY = Int32.Parse(data.Dequeue());
            this.planet.Activated(data);
        ...
        {
            data.Enqueue(currentIndexX.ToString());
            data.Enqueue(currentIndexY.ToString());
            this.planet.Deactivated(data);
        }
